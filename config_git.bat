...
git config --global user.name "Lucas1269"
git config --global user.email "lucasabrahao69@gmail.com"

:: Adiciona o repositório remoto (só executa se já não estiver adicionado)
git remote get-url origin >nul 2>&1
if errorlevel 1 (
    git remote add origin "https://github.com/Lucas1269/RepositorioJavaBasico.git"
)
